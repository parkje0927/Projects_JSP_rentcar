<%@page import="_04rentcar.CarViewBean"%>
	...
	<div align = "center">
		...
		<table border = "1">
			<tr height = "40">
				...
				<td width = "60" align = "center"> 베이비 시트 </td>
			...
			for (CarViewBean bean : v) {
				...
				<tr height = "70">
					...
					<td width = "90" align = "center">
						<button onclick = "location.href='15carReserveDel.jsp?id=<%=id %>&rday=<%=bean.getRday() %>'">삭제</button>
					</td>
				</tr>
			<% 		
			}
