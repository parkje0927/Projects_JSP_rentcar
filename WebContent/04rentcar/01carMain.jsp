...
SELECT * FROM rentcar ORDER BY no DESC LIMIT 3;
 ...
 => 위 아래는 바뀌지 않고 center 부분만 바뀌도록 화면을 구성하기 때문에 이와 같이 작성한다. 
 
 session.setAttribute 는 보통 회원가입, 로그인 에서 사용을 하고 그 외에 static변수와 같은 경우 이렇게 설정할 수 있다.
 --%>
...
<body>
	<div align = "center">
		...
		//처음 실행시에는 center 값이 넘어오지 않기에 null처리 해줌
		if (center == null) {
			center = "04center.jsp"; //default center값을 부여
		}
		%>
